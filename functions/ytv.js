...
const jsondata ={"youtube_id":videoID,"quality":360,"formatValue":0}
...
await delay(3)
let ucep = {"url":`https://www.youtube.com/watch?v=${videoID}`,"quality":360,"title":get_video_data.data.title,"formatValue":0}
...
await delay(3)
let insertdb = {"youtube_id":videoID,"server_path":download_video_ucep.data.download_link,"quality":360,"title":get_video_data.data.title,"formatValue":0}
